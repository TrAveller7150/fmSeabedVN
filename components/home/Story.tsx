...
function Text() {
  return (
    <div className="bg-[rgba(255,255,255,0.63)] content-stretch flex flex-col h-auto min-h-[628px] items-start justify-between not-italic px-[50px] py-[40px] relative shrink-0 w-[600px] rounded-lg backdrop-blur-sm" data-name="Text">
      ...
      <div className="flex flex-col font-['Inter','Noto_Sans_SC','Noto_Sans_JP',sans-serif] font-medium justify-center leading-[1.45] min-w-full relative shrink-0 text-[18px] text-[rgba(0,0,0,0.55)] tracking-[-0.09px] w-[min-content] whitespace-pre-wrap gap-6">
        <p className="mb-0">
